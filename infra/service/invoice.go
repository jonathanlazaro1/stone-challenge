...
// Invoice represents a service that handles view layer calls to fetch and modify Invoices
type Invoice struct {
...
func (svc *Invoice) GetMany(itemsPerPage int, page int, filterBy map[string]string, sortBy map[string]bool) ([]domain.Invoice, int64, error) {
	return svc.interactor.GetMany(itemsPerPage, page, filterBy, sortBy)
}

// Get an Invoice, given its Id
func (svc *Invoice) Get(id int) (*domain.Invoice, error) {
	return svc.interactor.Get(id)
}

// Add creates a new Invoice
func (svc *Invoice) Add(invoice domain.Invoice) (int, error) {
...
func (svc *Invoice) Update(id int, postModel PostModel) (*domain.Invoice, error) {
...
func (svc *Invoice) Delete(id int) (bool, error) {
